...
public:
	...
	Spaced_Qmer q;//length of q-mers of overlapping
	...
	Parameter():input_files(), nClus(0),
				q("111111111111111111111111111111"), m_thres(5), SEEDSIZE(20), l_mer_freq(4),
	...
	Parameter(	id_cluster_type nClus,
				Spaced_Qmer q, size_seq m_thres, size_seq_tot SEEDSIZE, size_seq l_mer_freq,
